...
# ./run_pipeline.sh <start_date> <end_date> <raw_data_folder> <processed_data_file> <model_file> <test_data_file> <predictions_file>
# For example:
...
# ./run_pipeline.sh 2020-01-01 2020-01-31 data/ data/processed_data.csv models/model.pkl data/test_data.csv predictions/predictions.json
...
python src/data_ingestion.py --start_date="$start_date" --end_date="$end_date" --output_file="$raw_data_folder"

# Run data_processing.py
echo "Starting data processing..."
python src/data_processing.py --input_folder="$raw_data_folder" --output_file="$processed_data_file"
